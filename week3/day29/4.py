...
#如果是单线程阻塞住就阻塞住了,下面走不了了,没有什么意义用队列,直接用列表就可以了
...
#     while li:
#         a=li[-1]#删除的是最后一个
#         print(a,n) #55   #第一个先sleep的,所以最先出来的也是第一个
#         time.sleep(2)
#         try:
# 	        print('删除前')
# 	        print('a的值是',a,n)
...
# 	        print('----',a,n)
#
# t1=threading.Thread(target=pri,args=('one',))
# t1.start()
# t2=threading.Thread(target=pri,args=('two',))
# t2.start()
